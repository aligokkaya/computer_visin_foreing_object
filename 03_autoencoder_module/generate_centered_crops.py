...
VIDEO_PATH = "sise.mp4"
OUTPUT_DIR = "dataset/train/clean_crops_480"
...
def center_crop_and_resize(img, ratio=0.6, size=480):
    h, w = img.shape[:2]
...
while True:
    ...
    for cnt in contours:
        ...
        out_path = os.path.join(OUTPUT_DIR, f"crop_{crop_count:06}.png")
        cv2.imwrite(out_path, processed)
        crop_count += 1

cap.release()
print(f"✅ {crop_count} adet 480x480 crop kaydedildi.")